...
> **一句话结论**：第一性原理计算仅用基本常数与原子序数，从电子结构推出复介电张量，得到折射率/双折射/反射率；DFT 带隙须 GW/BSE 修正方定量可靠。
...
| 通俗说法 | 严谨表述 | 误区根源 |
|---------|---------|---------|
| "第一性原理"就是不靠任何近似 | 仍含 DFT、微扰理论近似；只是不引入经验光学参数 | 把"无经验参数"当"无近似" |
| 折射率可直接由 DFT 算准 | LDA/GGA 带隙低估 30%–100%，原始 DFT 光学谱定量错误 | 忽略带隙系统性低估 |
| 双折射与晶体结构"无关" | 双折射=介电张量两本征值之差，是电子结构的量子起源 | 把宏观光学量当独立属性 |
